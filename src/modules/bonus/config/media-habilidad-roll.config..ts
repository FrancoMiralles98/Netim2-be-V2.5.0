...
export const MEDIA_HABILIDAD_ROLL_CONFIG:MediaHabilidadRollConfigType = {
    media: [
        { tier: 1, probability: 93, minValue: 1, maxValue: 25 },
        { tier: 2, probability: 4, minValue: 26, maxValue: 40 },
        { tier: 3, probability: 2.5, minValue: 41, maxValue: 50 },
        { tier: 4, probability: 0.5, minValue: 51, maxValue: 60 },
    ],
    habilidad: [
        { tier: 1, probability: 93, minValue: 1, maxValue: 12 },
        { tier: 2, probability: 4, minValue: 13, maxValue: 20 },
        { tier: 3, probability: 2.5, minValue: 21, maxValue: 25 },
